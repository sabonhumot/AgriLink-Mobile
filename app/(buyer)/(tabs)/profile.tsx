...
export default function ProfileScreen() {
  ...
  const infoItems = [
    { icon: "mail-outline" as const, label: "Email", value: mockBuyer.email },
    { icon: "call-outline" as const, label: "Phone", value: mockBuyer.phone },
    { icon: "location-outline" as const, label: "Address", value: mockBuyer.address },
    { icon: "calendar-outline" as const, label: "Member Since", value: mockBuyer.memberSince },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: "#F8FAF9" }}>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.name}>{mockBuyer.name}</Text>
